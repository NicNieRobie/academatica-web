...
namespace Academatica.Api.Auth.Data.Migrations.IdentityServer.AcadematicaDb
{
    ...
    [Migration("20220114210042_InitialAcadematicaDbMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Academatica.Api.Common.Models.SmartMathRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Academatica.Api.Common.Models.Class", b =>
                {
                    b.HasOne("Academatica.Api.Common.Models.Tier", "PrecedingTier")
                        .WithMany()
            ...
            modelBuilder.Entity("Academatica.Api.Common.Models.Topic", b =>
                {
                    b.HasOne("Academatica.Api.Common.Models.Tier", "PrecedingTopic")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Academatica.Api.Common.Models.SmartMathRole", null)
                        .WithMany()
